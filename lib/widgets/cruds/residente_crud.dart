...
class ResidenteCrud extends StatefulWidget {
  const ResidenteCrud({super.key});

  @override
  State<ResidenteCrud> createState() => _ResidenteCrudState();
}

class _ResidenteCrudState extends State<ResidenteCrud> {
  ...
  Future<void> eliminarUsuario(int id) async {
    final response = await http.delete(
      Uri.parse("http://10.0.2.2:8000/residentes/$id/"),
    );
