...
class AdministradorCrud extends StatefulWidget {
  ...
  @override
  State<AdministradorCrud> createState() => _AdministradorCrudState();
}

class _AdministradorCrudState extends State<AdministradorCrud> {
  ...
  Future<void> eliminarUsuario(int id) async {
    final response = await http.delete(
      Uri.parse("http://10.0.2.2:8000/administradores/$id/"),
    );
