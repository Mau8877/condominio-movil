...
class TrabajadorForm extends StatefulWidget {
  ...
  const TrabajadorForm({super.key, this.idUsuario});

  @override
  _TrabajadorFormState createState() => _TrabajadorFormState();
}
...
class _TrabajadorFormState extends State<TrabajadorForm> {
  ...
  Future<void> _fetchUsuario() async {
    ...
    final url = Uri.parse("http://10.0.2.2:8000/trabajadores/${widget.idUsuario}/");
    try {
  ...
  Future<void> _guardarUsuario() async {
    final url = widget.idUsuario == null
        ...
        : Uri.parse('http://10.0.2.2:8000/trabajadores/${widget.idUsuario}/');
