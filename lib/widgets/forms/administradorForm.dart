...
class AdministradorForm extends StatefulWidget {
  final String? idUsuario;

  const AdministradorForm({super.key, this.idUsuario});

  @override
  _AdministradorFormState createState() => _AdministradorFormState();
}

class _AdministradorFormState extends State<AdministradorForm> {
  // Controladores
  ...
  Future<void> _fetchUsuario() async {
    ...
    final url = Uri.parse("http://10.0.2.2:8000/administradores/${widget.idUsuario}/");
  ...
  Future<void> _guardarUsuario() async {
    final url = widget.idUsuario == null
        ? Uri.parse('http://10.0.2.2:8000/administradores/')
