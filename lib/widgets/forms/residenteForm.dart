...
class ResidenteForm extends StatefulWidget {
  final String? idUsuario;

  const ResidenteForm({super.key, this.idUsuario});

  @override
  _ResidenteFormState createState() => _ResidenteFormState();
}

class _ResidenteFormState extends State<ResidenteForm> {
  // Controladores
  ...
  Future<void> _fetchUsuario() async {
    ...
    final url = Uri.parse("http://10.0.2.2:8000/residentes/${widget.idUsuario}/");
  ...
  Future<void> _guardarUsuario() async {
    final url = widget.idUsuario == null
        ? Uri.parse('http://10.0.2.2:8000/residentes/')
